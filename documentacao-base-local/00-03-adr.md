...
- Precisa confirmar o nome exato do pacote npm oficial do MCP SDK v2 no momento da implementação (ver [06-stack.md §2](./00-06-stack.md#2-sdk-mcp)).
